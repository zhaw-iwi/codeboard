...
var util = require('./../util.js'),
    operations = require('sequelize').Op;
...
module.exports = function(sequelize, DataTypes) {
  ...
  var User = sequelize.define(
    ...
    User.associate = function(models) {
        ...
        User.belongsToMany(models.Course, {as: 'courseOwnerSet', through: 'CourseOwners'}); // todo delete
        User.belongsToMany(models.Course, {as: 'courseUserSet', through: 'CourseUsers'}); // todo delete

        // todo stimmt das so?
        User.hasMany(models.CourseUserNew, {as:  'userCourseSetNew', foreignKey: 'userId'});
