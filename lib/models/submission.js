...
module.exports = function(sequelize, DataTypes) {
  var Submission = sequelize.define(
    'Submission',
    {
      ...
      // does the submission has a code review
      hasCodeReview: {
    ...
    Submission.associate = function(models) {
        ...
        Submission.belongsTo(models.Course, {as: 'course', foreignKeyConstraint: true, constraints: false, defaultValue: -1}); // Note: disable the default constraints of belongsTo because a request might not have a course
    };
