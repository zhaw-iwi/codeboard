...
module.exports = function(app) {
  ...
  app.post('/api/ai/compilerExplanation/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getCompilerExplanation);
  app.post('/api/ai/codeExplanation/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getCodeExplanation);
  app.post('/api/ai/codeReview/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getCodeReview);
  app.post('/api/ai/help/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getHelp);
