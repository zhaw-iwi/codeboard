...
module.exports = function(app) {
  ...
  app.get('/api/courses/:courseId/settings', mw.isValidCourseId, mw.isAuth, mw.isCourseAdvisor, courseCtrl.getCourseSettings);
  app.put('/api/courses/:courseId/settings', mw.isValidCourseId, mw.isAuth, mw.isCourseAdvisor, courseCtrl.putCourseSettings);
  app.delete('/api/courses/:courseId', mw.isValidCourseId, mw.isAuth, mw.isCourseAdvisor, courseCtrl.deleteCourse);


  app.post('/api/courses', mw.isAuth, courseCtrl.createCourseForUser);

  app.get('/api/users/:username/courses/', mw.isAuth, mw.isSelf, courseCtrl.getUserCourses);

  app.get('/api/courses/:courseId', mw.isValidCourseId, mw.isAuthElseNextRoute, mw.isCourseAdvisorElseNextRoute, courseCtrl.getFullCourse);
  app.get('/api/courses/:courseId', mw.isValidCourseId, mw.isAuthElseNextRoute, courseCtrl.getLimitedCourse);


  app.get('/api/courses/:courseId/projects', mw.isAuth, mw.isValidCourseId, mw.isCourseAdvisor, courseCtrl.getCourseProjects);
  ...
  app.get('/api/courses/:courseId/userProjects', mw.isAuth, mw.isValidCourseId, courseCtrl.getCourseUserProjects); // todo check isCourseOwner
  app.get('/api/courses/:courseId/projects/:projectId/userprojects', mw.isAuth, mw.isValidProjectId, mw.isValidCourseId, mw.isOwner, courseCtrl.getCourseProjectUserProjects);
  ...
  app.get('/api/courses/:courseId/submissions', mw.isAuth, mw.isValidCourseId, courseCtrl.getCourseSubmissions); // todo check isCourseOwner
  app.get('/api/courses/:courseId/projects/:projectId/submissions', mw.isAuth, mw.isValidProjectId, mw.isValidCourseId, mw.isOwner, courseCtrl.getCourseProjectSubmissions);
  ...
  app.get('/api/courses/:courseId/helpRequests', mw.isAuth, mw.isValidCourseId, courseCtrl.getCourseHelpRequests); // todo check isCourseOwner
  app.get('/api/courses/:courseId/projects/:projectId/helpRequests', mw.isAuth, mw.isValidProjectId, mw.isValidCourseId, mw.isOwner, courseCtrl.getCourseProjectHelpRequests);
