...
module.exports = function(app) {
  ...
  app.post('/api/projects/:projectId/helpRequests', mw.isValidProjectId, mw.isAuthElseNextRoute, mw.isLtiUserElseNextRoute, projectCtrl.createHelpRequest);
  app.post('/api/projects/:projectId/helpRequests', mw.isPublicProject, projectCtrl.createHelpRequest); // used to send 401 todo
  ...
  app.post('/api/:projectId/help/compilation', projectCtrl.getHelpForCompilation);
  ...
  app.post('/api/ai/hints/:userId/:courseId/:projectId', mw.isAuth, mw.hasCourseId, aiCtrl.getRelevantHint);
  app.post('/api/ai/compiler/:userId/:courseId/:projectId', mw.isAuth, mw.hasCourseId, aiCtrl.getCompilerExplanation);
