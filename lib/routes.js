...
module.exports = function(app) {
  ...
  app.post('/lti/projects/:projectId', mw.checkredirectLtiUrl, mw.isValidProjectId, mw.isLtiRequestAuthorized, mw.isAuthElseNextRoute, mw.isLtiUserIdEqualsUserName, projectCtrl.initLtiSession);
  app.post('/lti/projects/:projectId', mw.checkredirectLtiUrl, mw.isReturningLtiUserElseNextRoute, authCtrl.authenticateLtiUserElseNextRoute, projectCtrl.initLtiSession);
  app.post('/lti/projects/:projectId', mw.checkredirectLtiUrl, mw.isReturningLtiUserElseNextRoute, authCtrl.updateLtiUserPassword, authCtrl.authenticateLtiUserElseNextRoute, projectCtrl.initLtiSession); // quickfix for changing moodle lis_person_source_id todo maybe replace
  app.post('/lti/projects/:projectId', mw.checkredirectLtiUrl, mw.isLtiUserCreatableElseNextRoute, authCtrl.authenticateLtiUserElseNextRoute, projectCtrl.initLtiSession);
  ...
  app.post('/api/ai/hints/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getRelevantHint);
  app.post('/api/ai/compiler/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getCompilerExplanation);
  app.post('/api/ai/explanation/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getCodeExplanation);
  app.post('/api/ai/codeReview/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getCodeReview);
  app.get('/api/ai/stats', mw.isAuth, aiCtrl.getUsageStats);
