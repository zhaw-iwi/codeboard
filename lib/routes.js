...
module.exports = function(app) {
  ...
  app.post('/api/ai/hints/:userId/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getRelevantHint);
  app.post('/api/ai/compiler/:userId/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getCompilerExplanation);
  app.post('/api/ai/explanation/:userId/:courseId/:projectId', mw.isAuth, mw.hasCourseId, mw.checkReqLimit, aiCtrl.getCodeExplanation);
