...
module.exports = function(app) {
  ...
  app.post('/api/ai/hints/:userId/:courseId/:projectId', mw.isAuth, aiCtrl.getRelevantHint);
  app.post('/api/ai/compiler/:userId/:courseId/:projectId', mw.isAuth, aiCtrl.getCompilerExplanation);
