...
module.exports = function(app) {
  ...
  app.post('/api/ai/hints/:username/:courseId/:projectId', mw.isAuth, aiCtrl.getRelevantHint);
  app.post('/api/ai/compiler/:username/:courseId/:projectId', mw.isAuth, aiCtrl.getCompilerExplanation);
