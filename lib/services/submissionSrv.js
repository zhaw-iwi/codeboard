 ...
 */
var _getSubmissionsInCompactView = function (args, orderBy = null) {
 ...
 * @return {*} a Promise that resolves to Json array with submission data if the db query is successful
 */
var _getSubmissionsInFullView = function (args, orderBy = null) {
    ...
    if (args.testResult !== undefined) {
        _whereClause.testResult = {
            [db.Sequelize.Op.gte]: args.testResult
        };
    }
 ...
 */
var getSubmissions = function(projectId, userId = null, courseId = null, orderBy = null, args = {}, viewType = null) {
    let _args = {
        projectId: projectId,
    ...
    return (viewType === 'compact') ? _getSubmissionsInCompactView(_args, orderBy) : _getSubmissionsInFullView(_args, orderBy);
};
