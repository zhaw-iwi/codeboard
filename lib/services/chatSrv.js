  ...
  return Promise.all([getAuthor, projectUser])
    ...
    .then(function (chatLine) {
      ...
      return getChatLine(chatLine.id).then(function (chatLine) {
        ...
        // help requests
        // exception: if the type is helpRequestChatbot, we do not send a mail because the answer
        // is generated by the llm
        else if (aChatLine.authorId === aChatLine.userId && chatLine.type !== 'helpRequestChatbot') {
          mailSrv
