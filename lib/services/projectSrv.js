 ...
 * @param listOfCourses
 */
var setCoursesOfProject = function(project, listOfCourses) {
  return db.Course.findAll({
    where: {id: {[Op.in]: listOfCourses}}
  })
    .then(function(courses) {
      return project.setCourseSet(courses)
          .then(function() {
              return project;
          });
    });
 ...
 */
var getAllChangeableUserFiles = async function(userId, courseId, projectId) {
  try {
    ...
    console.log("Error while fetching the code of the user: " + err);
    return err;
  }
}
 ...
 * @return {String} the shortened description
 */
var getSampleSolution = async function(prjId, usrId, crsId) {
...
exports.setCoursesOfProject = setCoursesOfProject;
...
exports.getAllChangeableUserFiles = getAllChangeableUserFiles;
...
exports.getSampleSolution = getSampleSolution;
