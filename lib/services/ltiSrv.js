        ...
        .then(function(session) {
            ...
            if(session !== null) {
                ...
                if(session.CourseId !== courseId) {
                    return Promise.reject("Access rejected because user's supplied courseId (" + courseId + ") does not match with the courseId stored in the ltiSession (" + session.CourseId + ")");
                }
