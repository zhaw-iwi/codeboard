...
var checkReqLimit = async function(req, res, next) {
  try {
    ...
    if (userLimit && userLimit.limitExceeded) {
      ...
      return res.status(200).json(userLimit);
    }
...
exports.setProjectIdFromLtiRequest  = setProjectIdFromLtiRequest ;
...
exports.hasCourseId = hasCourseId;
exports.checkReqLimit = checkReqLimit;
