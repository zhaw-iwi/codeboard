 ...
 */
const checkredirectLtiUrl = function(req, res, next) {
  // if a custom project id was set in moodle (new version) we need to set the projectId in the route to further process it
  if (!req.params.projectId && req.body.custom_project_id) {
    req.params.projectId = req.body.custom_project_id;
  }

  // otherwise the request was made to /lti/projects/<id> and we can directly process the request
  next();
};
...
exports.checkredirectLtiUrl = checkredirectLtiUrl;
