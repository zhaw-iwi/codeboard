 ...
 * @private
 */
const getEncryptedPassword = function (aPassword, aSalt) {
  if (!aPassword || !aSalt) return '';
  return crypto.pbkdf2Sync(aPassword, aSalt, 10000, 64, 'sha512').toString('base64');
};
 ...
 * @private
 */
const verifyPassword = function (aPasswordClearText, aHashedPassword, aSalt) {
