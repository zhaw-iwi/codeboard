...
var getUser = function(req, res) {
  ...
  userSrv.getUser(req.params.username, ['id', 'username', 'email', 'emailPublic', 'name', 'url', 'location', 'institution'])
  .then(function(user) {
    if(user === null) {
...
var getUserSettings = function(req, res) {
  ...
  userSrv.getUser
    (
      req.user.username,
      ['id', 'username', 'email', 'emailPublic', 'name', 'url', 'location', 'institution']
    )
    .then(function(usr) {
      if(usr === null) {
