      ...
      if (result === null) {
        ...
        db.TemplateProject.create({
          ...
          .then(function (templateFile) {
            //console.log('Current working directory: ' + process.cwd());
            // reads the file relative the process.cwd() (that's where server.js lives)
            var _content = fs.readFileSync(config.dbTemplates + '/Java/Root/projectDescription.html', 'utf8');

            return db.TemplateFile.create({
              filename: 'projectDescription.html',
              path: 'Root',
              uniqueId: 3,
              parentUId: 0,
              isFolder: false,
        ...
        db.TemplateProject.create({
          ...
          .then(function (templateFile) {
            ...
            var _content = fs.readFileSync(
              config.dbTemplates + '/Java-JUnit/Root/test_submission/SubTest.java',
              'utf8'
            );
    ...
    db.TemplateProject.findOne({
      ...
      if (result === null) {
        ...
        db.TemplateProject.create({
          ...
          .then(function (templateFile) {
            var _content = fs.readFileSync(
              config.dbTemplates + '/Python-UnitTest/Root/testSubmission/__init__.py',
              'utf8'
            );
          ...
          .then(function (templateFile) {
            var _content = fs.readFileSync(
              config.dbTemplates + '/Python-UnitTest/Root/testSubmission/subTest.py',
              'utf8'
            );
