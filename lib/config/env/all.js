...
// __dirname = absolute path where this file lives + go up three levels to project root
...
module.exports = {
  ...
  // configuration for session (auth) data
  sessionSettings: {
    uri: process.env.SESSION_STORE_URI || 'mongodb://localhost:27017/cobo_sessions',
    cookieName: 'codeboard',
    secret: process.env.SESSION_SECRET || 'evmdoaafxeosuqsifcpnbmdhvxeam',
  },
  ...
  // azure gpt-4 instance
  gpt: {
    openaiAPIKey: process.env.OPENAI_API_KEY,
    endpoint: process.env.OPENAI_DEPLOYMENT_ENDPOINT,
    deploymentId: process.env.OPENAI_DEPLOYMENT_NAME,
